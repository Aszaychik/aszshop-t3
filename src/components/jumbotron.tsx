...
export default function Jumbotron() {
  return (
    <main className="flex justify-center items-center relative  text-center w-full h-48 sm:h-96 lg:h-96 bg-white">
      ...
      priority
      />
      <div className="absolute flex flex-col justify-center items-center gap-12 h-full text-black text-2xl">
